...
class GenericSearch:
    ...
    def __call__(self):
        open_list = self.data_struct_type()
        if self.usePriorityQueue:
            open_list.push((self.problem.getStartState(), []), self.heuristic(self.problem.getStartState(),
                                                                              self.problem))
        else:
        ...
        while True:
            ...
            if coord not in closed:
                ...
                for successor_coord, action, step_cost in \
                    ...
                    if self.usePriorityQueue:
                        open_list.push((successor_coord, actions + [action]),
